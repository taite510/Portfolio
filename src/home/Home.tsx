    ...
    <React.Fragment>
      <Container maxWidth='sm'>
        <Box sx={{ bgcolor: '#495a81', height: 'auto', margin: '80px 0', borderRadius: '10px', padding: '10px' }}>
          ...
          Former marine biologist / Bering Sea survivor turned webdev. <br/> Enjoys building React apps and designing backend archetecture. <br/> Please hire him.
          </Typography>
          <Box sx={{ bgcolor: '#546da6', height: '50px', borderRadius: '10px', padding: '10px', margin: '20px 0' }}>
